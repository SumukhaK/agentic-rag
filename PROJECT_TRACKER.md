...
- **Deployment hardening (Phase 8)** — scoped to containerizing the
  ...
  [Deployment](README.md#deployment) section of `README.md` for the full
  caveat. A 9th,
...
- **Real 10,000-document load test attempted (Phase 8)** — the run itself,
  ...
  [Real 10,000-Document Load Test — Results](README.md#real-10000-document-load-test--results)
  section of `README.md` and [`loadtest/README.md`](loadtest/README.md): per-doc
